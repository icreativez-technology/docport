		...
		<div class="container content-area">
					<div class="">
						...
						<div class="page-header">
							<h1 class="page-title"><span class="subpage-title">Welcome To</span> DocPort Logistics Dashboard</h1>
						</div>
						<!-- End page-header -->
							...
							<div class="col-sm-6 col-lg-6 col-xl-3">
								<div class="card text-center">
									<div class="card-body">
										...
										<h2 class="mb-2 number-font"><i class="fa fa-first-order" aria-hidden="true"></i> 2,891</h2>
							...
							<div class="col-sm-6 col-lg-6 col-xl-3">
								<div class="card text-center">
									<div class="card-body">
										...
										<h2 class="mb-2 number-font"><i class="fa fa-money" aria-hidden="true"></i> 2,892</h2>
										<!-- <p class="mb-0 text-muted">
							...
							<div class="col-sm-6 col-lg-6 col-xl-3">
								<div class="card text-center">
									<div class="card-body">
										...
										<h2 class="mb-2 number-font"><i class="fa fa-handshake-o" aria-hidden="true"></i> 12,789</h2>
										<!-- <p class="mb-0 text-muted">
							...
							<div class="col-sm-6 col-lg-6 col-xl-3">
								<div class="card text-center">
									<div class="card-body">
										...
										<h2 class="mb-2 number-font"><i class="fa fa-truck"></i> 679</h2>
										<!-- <p class="mb-0 text-muted">
										...
										<div class="table-responsive">
											<table class="table table-bordered  mb-0 text-nowrap">
												...
												<tbody>
													<tr>
														<td>
															<img :src="baseUrl+`/assets/images/users/female/1.jpg`" class="avatar brround" alt="">
														</td>
														<td>Emily Poole</td>
														<td>PRO12345</td>
													...
													<tr>
														<td>
															<img :src="baseUrl+`/assets/images/users/female/3.jpg`" class="avatar brround" alt="">
														</td>
														<td>Sarah Alsop</td>
														<td>PRO23457</td>
													...
													<tr>
														<td>
															<img :src="baseUrl+`/assets/images/users/male/4.jpg`" class="avatar brround" alt="">
														</td>
														<td>Ruth Hart</td>
														<td>PRO94567</td>
														<td>Online Payment</td>
													...
													<tr>
														<td>
															<img :src="baseUrl+`/assets/images/users/female/5.jpg`" class="avatar brround" alt="">
														</td>
														<td>Peter Ince</td>
														<td>PRO56789</td>
														<td>Cash on delivered</td>
													...
													<tr>
														<td>
															<img :src="baseUrl+`/assets/images/users/male/6.jpg`" class="avatar brround" alt="">
														</td>
														<td>Sophie	Ross</td>
														<td>PRO30978</td>
														<td>Online Payment</td>
											...
											<ul class="contacts mb-0">
												<li>
													<div class="d-flex bd-highlight">
														<div class="img_cont">
															<img :src="baseUrl+`/assets/images/users/male/3.jpg`" class="rounded-circle user_img" alt="img">
												...
												<li>
													<div class="d-flex bd-highlight">
														<div class="img_cont">
															<img :src="baseUrl+`/assets/images/users/female/1.jpg`" class="rounded-circle user_img" alt="img">
												...
												<li>
													<div class="d-flex bd-highlight">
														<div class="img_cont">
															<img :src="baseUrl+`/assets/images/users/female/9.jpg`" class="rounded-circle user_img" alt="img">
															<span class="online_icon"></span>
														</div>
														<div class="user_info">
															<h6 class="mt-1 mb-0 ">Maryam Naz</h6>
												...
												<li>
													<div class="d-flex bd-highlight">
														<div class="img_cont">
															<img :src="baseUrl+`/assets/images/users/female/10.jpg`" class="rounded-circle user_img" alt="img">
												...
												<li>
													<div class="d-flex bd-highlight">
														<div class="img_cont">
															<img :src="baseUrl+`/assets/images/users/male/5.jpg`" class="rounded-circle user_img" alt="img">
															<span class="online_icon"></span>
														</div>
														<div class="user_info">
												...
												<li>
													<div class="d-flex bd-highlight">
														<div class="img_cont">
															<img :src="baseUrl+`/assets/images/users/male/7.jpg`" class="rounded-circle user_img" alt="img">
															<span class="online_icon"></span>
														</div>
														<div class="user_info">
												...
												<li>
													<div class="d-flex bd-highlight">
														<div class="img_cont">
															<img :src="baseUrl+`/assets/images/users/female/8.jpg`" class="rounded-circle user_img" alt="img">
