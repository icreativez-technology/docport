<template>
    <div class="modal fade" id="addCondition" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
  <div class="modal-dialog addBooking" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h6 style="color:black;">Add Condition</h6>
       ...
       <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          <button class="nav-link active">Condition</button>
        </div>
      </nav>
       <div class="tabcontent">
           <form @submit.prevent="addBooking">
            <div class="form-row">
              <div class="form-group col-md-4">
                <label for="inputEmail4">Condition Number</label>
                   <select class="form-control" v-model="condition.week_number">
            ...
            <div class="form-row">
                ...
                <label for="inputPassword4">Damage Outside / Inside</label>
                         <select class="form-control" v-model="condition.seal_id">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                    <input type="checkbox" class="form-control"  v-model="condition.order_time">Fixed by BalticRail
            </div>
        </div>
