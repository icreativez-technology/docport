<template>
<div class="modal fade" id="addGoods" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
  <div class="modal-dialog addBooking" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h6 style="color:black;">Add Goods</h6>
       ...
       <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          <button class="nav-link active">Goods</button>
        </div>
      </nav>
           ...
           <form @submit.prevent="addBooking">
            <div class="form-row">
              <div class="form-group col-md-3">
                <label for="inputEmail4">Empty / Loaded - Container Gross</label>
                    <input type="date" class="form-control" v-model="booking.door_date">
              </div>
              <div class="form-group col-md-3">
                <label for="inputPassword4">Size / type - VGM</label>
